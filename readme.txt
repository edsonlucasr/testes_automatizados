...
Adicionar o caminho X:\TesteDasa\drivers em "Path" nas variáveis de ambiente para os usuários e para o sistema (Path, Editar, Novo, colar o caminho completo, OK.) Os drivers estão incluidos no projeto
